        ...
        <>
            <section className="bg-white min-h-screen px-6 py-20 flex items-center justify-center">
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
                    <div>
                        <h1 className="font-title text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-[#0F172A]">Book Your Visit</h1>
                        <p className="pt-6 sm:pt-8 text-gray-600 text-sm sm:text-base max-w-xl mx-auto lg:mx-0">Ready to experience one-on-one therapy focused on you? Use our Jane booking system or contact us directly.</p>
                        {/* LOCATION */}
