        ...
        <>
            <header className="bg-white/95 border border-gray-100 shadow z-50 py-3 px-5 flex items-center justify-between fixed top-0 left-0 w-full">
                ...
                <nav className="space-x-8 text-gray-700 font-title font-medium hidden lg:block z-10">
                    ...
                    <a href="#Insurance" className="relative inline-block after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-0.5 after:w-0 after:bg-[#0037b0] after:transition-all after:duration-300 hover:after:w-full hover:text-[#0037b0]">Insurance</a>
                ...
                <a href="https://theraonemr.janeapp.com/#/staff_member/1/treatment/4" target="_blank" className="hidden lg:block bg-[#0037b0] hover:bg-[#142c6c] transition text-white py-2 px-5 text-sm font-bold font-title rounded-2xl">BOOK APPOINTMENT</a>
                {/* MOBILE SIDEBAR */}
                ...
                <div className={`bg-white fixed top-0 right-0 h-full lg:hidden p-5 w-[90%] transition-all duration-300 ${isOpen ? 'translate-0 opacity-100 z-50' : 'translate-x-100 opacity-0 z-0'}`}>
                    ...
                    <nav className="flex flex-col space-y-8 text-gray-700 font-title font-semibold text-lg mt-8">
                        ...
                        <a href="#Insurance" className="flex items-center justify-between" onClick={() => setIsOpen(false)}>Insurance <ChevronRight size={20}/></a>
                    ...
                    <a href="https://theraonemr.janeapp.com/#/staff_member/1/treatment/4" target="_blank" className="border flex w-full items-center justify-center py-3 mt-5 gap-1 text-white text-sm font-bold font-title rounded-2xl bg-[#0037b0] hover:bg-[#142c6c]"><Calendar size={20}/>Book Appointment</a>
                </div>
            </header>
        </>
    );
