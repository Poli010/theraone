    ...
    return(
        <>
            <header className="bg-white/95 border border-gray-100 shadow z-50 py-3 px-5 flex items-center justify-between fixed top-0 left-0 w-full">
                ...
                <nav className="space-x-8 text-gray-700 font-title font-medium hidden lg:block">
                ...
                <div className={`bg-white fixed top-0 right-0 h-full  p-5 w-[90%] transition-all duration-300 ${isOpen ? 'translate-0 opacity-100 z-50' : 'translate-x-100 opacity-0 z-0'}`}>
                    ...
                    <nav className="flex flex-col space-y-8 text-gray-700 font-title font-semibold text-lg mt-8">
                        <a href="#About" className="flex items-center justify-between">About <ChevronRight size={20}/></a>
                        <a href="#Contact" className="flex items-center justify-between">Contact <ChevronRight size={20}/></a>
                        <a href="#Services" className="flex items-center justify-between">Services <ChevronRight size={20}/></a>
                        <a href="#Medicare" className="flex items-center justify-between">Medicare <ChevronRight size={20}/></a>
                        <a href="#Testimonials" className="flex items-center justify-between">Testimonials <ChevronRight size={20}/></a>
                    </nav>
