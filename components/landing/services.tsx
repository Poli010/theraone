...
export default function Services(){
    ...
    return(
        <>
            <section className="min-h-screen bg-[#EFF4FF] px-6 py-20 flex flex-col items-center justify-center">
                <div className="text-center max-w-2xl">
                    <h1 className="font-title text-4xl md:text-5xl font-bold text-[#0F172A]">Our Specialized Care</h1>
                    <p className="mt-6 text-gray-600 text-base md:text-lg leading-7"> Focused on evidence-based practices to restore your function and enhance your quality of life.</p>
                </div>
                <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl">
                    {services.map((s, index) => (
                        <div key={index} className="bg-white rounded-xl p-8 shadow-sm hover:shadow-xl transition duration-300">
                            ...
                            <h3 className="font-title font-semibold text-lg mt-5 text-[#0F172A]">{s.title}</h3>
