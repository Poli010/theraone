        ...
        <>
            <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
                ...
                <div className="absolute z-7 max-w-160 x-auto left-30">
                    ...
                    <p className="text-sm font-title pt-5 text-gray-700">Individualized care for Medicare Part B patients in NY. No rushed sessions, no factory lines. Experience the difference of dedicated movement expertise.</p>
                    <div className="pt-5">
