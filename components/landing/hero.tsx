        ...
        <>
            <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
                ...
                <div className="relative z-10 px-6 sm:px-10 lg:px-20 max-w-3xl py-28">
                    ...
                    <p ref={(ref) => setRef(ref!, 2)} style={{animationDelay: '0.5s'}} className={`${inView[2] ? 'animate-fade_up' : 'opacity-0'} text-sm sm:text-base pt-6 text-gray-700 leading-relaxed max-w-2xl`}>Individualized care for Medicare Part B, private-pay, and select insurance patients throughout New York. No rushed sessions, no factory-line treatment. Experience the difference of dedicated one-on-one physical therapy delivered directly to your home.</p>
                    <div ref={(ref) => setRef(ref!, 3)} style={{animationDelay: '0.8s'}} className={`${inView[3] ? 'animate-fade_up' : 'opacity-0'} pt-8 flex flex-col sm:flex-row gap-3 lg:gap-0`}>
                        <a href="https://theraonemr.janeapp.com/#/staff_member/1/treatment/4" target="_blank" className="text-center font-title py-3 px-7 bg-[#0037b0] hover:bg-[#142c6c] transition cursor-pointer text-white rounded-md text-[10pt] font-semibold">Book Your Evaluation</a>
